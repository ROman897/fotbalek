...
using compSettings =
    ComponentSettings<Transform, RectangleShape, RigidBody, CircleCollider,
                      RectangleCollider, Sprite, MovementInputHolder, Button,
                      Label, NetworkId, PlayerComp, ColliderTrigger, GameState,
                      GameStateChange, BallComp>;
...
using SystemSignature_Circle_Collider_Body =
    Signature<CircleCollider, RigidBody, Transform>;
using SystemSignature_Rectangle_Collider_Body =
    Signature<RectangleCollider, RigidBody, Transform>;
using SystemSignature_Circle_Collider = Signature<CircleCollider, Transform>;
using SystemSignature_Rectangle_Collider =
    Signature<RectangleCollider, Transform>;
...
using SystemSignature_Network_Player =
    Signature<NetworkId, Transform, PlayerComp>;
using SystemSignature_Player_Rigid =
    Signature<RigidBody, Transform, PlayerComp>;
...
using SystemSignature_TCollider_Circle =
    Signature<CircleCollider, Transform, ColliderTrigger>;
using SystemSignature_TCollider_Rectangle =
    Signature<RectangleCollider, Transform, ColliderTrigger>;

// define which signatures will the engine use
using sigSettings = SignatureSettings<
    SystemSignature_SpriteGraphic, SystemSignature_Movable,
    SystemSignature_Circle_Collider_Body,
    SystemSignature_Rectangle_Collider_Body, SystemSignature_Input,
    SystemSignature_Button, SystemSignature_LabelGraphic,
    SystemSignature_RectangleGraphic, SystemSignature_Network_Input,
    SystemSignature_Network, SystemSignature_Network_Graphic,
    SystemSignature_Rectangle_Collider, SystemSignature_Circle_Collider,
    SystemSignature_Network_Rigid, SystemSignature_Network_Player,
    SystemSignature_GameState, SystemSignature_ColliderTrigger,
    SystemSignature_GameStateChange, SystemSignature_Player_Rigid,
    SystemSignature_Ball_Rigid, SystemSignature_Ball, SystemSignature_Label,
    SystemSignature_TCollider_Circle, SystemSignature_TCollider_Rectangle>;
