...
struct RectangleShape {
  ...
  RectangleShape(int x, int y, int mWidth, int mHeight,
                 const SDL_Color &m_color, GraphicLayers layer, bool enabled)
      : x(x), y(y), mWidth(mWidth), mHeight(mHeight), m_color(m_color),
