...
/**
 * this struct defines dealloc function for each of the smart pointer wrappers provided below
 * so they can dealloc themselves using right function chosen by SDL_Deleter base on type of argument it gets
 */
struct SDL_Deleter {
