...
Id spawnPlayer_Server(EngineType_Server &gameEngine) {
  ...
  gameEngine.addComponent<RectangleCollider>(
      id, ServerGameConstants::kPlayerColliderTopLeft,
      ServerGameConstants::kPlayerColliderBottomRight,
      ServerGameConstants::kPlayerCollisionLayer);

  gameEngine.addComponent<RigidBody>(id,
                                     ServerGameConstants::kPlayerInverseMass,
                                     ServerGameConstants::kPlayerRestitution,
                                     ServerGameConstants::kPlayerSpeedDecrement,
                                     ServerGameConstants::kPlayerMaxVelocity);
...
Id spawnBall_Server(EngineType_Server &gameEngine) {
  ...
  gameEngine.addComponent<CircleCollider>(
      id, ServerGameConstants::kBallColliderCenter,
      ServerGameConstants::kBallColliderRadius,
      ServerGameConstants::kBallCollisionLayer);
  gameEngine.addComponent<RigidBody>(id, ServerGameConstants::kBallInverseMass,
                                     ServerGameConstants::kBallRestitution,
                                     ServerGameConstants::kBallSpeedDecrement,
                                     ServerGameConstants::kBallMaxVelocity);
...
Id spawnBarrier_Server(EngineType_Server &gameEngine, Vector_Float position,
  ...
  gameEngine.addComponent<RectangleCollider>(
      id, topLeft, m_bottomRight, ServerGameConstants::kBarrierCollisionLayer);
  gameEngine.addComponent<RigidBody>(
      id, ServerGameConstants::kBarrierInverseMass,
      ServerGameConstants::kBarrierRestitution,
      ServerGameConstants::kBarrierMaxVelocity,
      ServerGameConstants::kBarrierSpeedDecrement);
  return id;
}
...
Id spawnGoalTrigger_Server(EngineType_Server &gameEngine, Vector_Float position,
  ...
  gameEngine.addComponent<Transform>(id, position);
  gameEngine.addComponent<RectangleCollider>(
      id, ServerGameConstants::kGoalBotRight,
      ServerGameConstants::kGoalCollisionLayer);
