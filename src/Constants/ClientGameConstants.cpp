...
//-------------------------Football pitch
const std::string ClientGameConstants::kPitchSpritePath =
    "../Resources/Sprites/Pitch.png";
...
const std::string ClientGameConstants::kButtonSpritePath =
    "../Resources/Sprites/Button.png";
...
const std::string ClientGameConstants::kButtonFontPath =
    "../Resources/Fonts/BasicFont.ttf";
...
const std::string ClientGameConstants::kPlayerSpritePath_Team1 =
    "../Resources/Sprites/Player1.png";
const std::string ClientGameConstants::kPlayerSpritePath_Team2 =
    "../Resources/Sprites/Player2.png";
//----------------------//Player Sprite

//------------------------Player Label
const Vector_Float ClientGameConstants::kPlayerLabelOffset = {0, 40};
const std::string ClientGameConstants::kPlayerLabelFontPath =
    "../Resources/Fonts/BasicFont.ttf";
...
//-------------------------Labels
const Vector_Float ClientGameConstants::kLabelPosition = {330, 350};
const Vector_Float ClientGameConstants::kLabelOffset = {0, 0};
const std::string ClientGameConstants::kLabelFontPath =
    "../Resources/Fonts/BasicFont.ttf";
const SDL_Color ClientGameConstants::kLabelFontColor = {255, 0, 0, 255};
const int ClientGameConstants::kLabelFontSize = 70;
...
const std::string ClientGameConstants::kArrowSpritePath =
    "../Resources/Sprites/Ball.png";
//------------------------Selection Arrow

//----------------------Ball
const Vector_Float ClientGameConstants::kBallSpriteOffset = {-16, -16};
...
const std::string ClientGameConstants::kBallSpritePath =
    "../Resources/Sprites/Ball.png";
//-----------------------//Ball
